<html>
	...
	<body text-transform="UPPERCASE" style="background-color:beige">
	<form action="checklogin1.jsp" name="chkform">
	...
	<h1 style="background-color:#7FFF00;">Online Registration Form </br></h1>
            ...
            <marquee direction ="right" scrollamount="4" behavior="alternate" border="2pt">Payment Of challan should be done at SBI branches only</marquee>  </font>
	</br></br>
...
<tr>
	<td><a href="photo.jsp">Upload Photos</a></td>	
</tr>
...
<center>
	...
	<p style="background-color:lightblue">To enter your Stage-2 details please login</p>
	</font>
	</td>
...
<tr>
	...
	<td>
	<input type="text" id="dob" name="dob1" required="true" size="30"><font color="blue" placeholder="dd-mm-yy"/>[DD-MM-YY]
</tr>
...
<tr>
<label class="col-sm-2 control-label"><span class="light"><font size="5">CREDENTIALS DID NOT MATCH</font></span></label>
</tr>
</table>
...
<style>
.light{font-family: Times New Roman;font-style: bold; font-weight: bold; color:red;}</style>
</html>