...
<center>
	...
	<font size="6px" color="black">
        <p style="background-color:#e6f2ff"><font color="blue">Login First to Continue</font></p>
	</font>
	</td>
...
<tr>
	...
	<input id="no1" type="text" size="30" name="reg1" placeholder="Enter Registration No"required="true">
        ...
        <%
            String n=request.getParameter("reg1");
            session.setAttribute("rnoo",String.valueOf(n));
        %>
